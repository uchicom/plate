 ...
 * 
 */
public class DropCmd extends AbstractCmd {
	 ...
	 * @param plate
	 */
	public DropCmd(Commander broker) {
		super(CMD, broker);
	}
	...
	public String getHelp() {
		return " " + CMD + ": port drop\r\n"
				+ "  format)drop [hostname:]port\r\n"
				+ "  ex)drop 8080\r\n";
	}
	...
	public boolean execute(CmdSocketHandler handler, String[] params) {
		...
		return broker.getMain().dropPort(port);
