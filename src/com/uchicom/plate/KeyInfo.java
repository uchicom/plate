...
public class KeyInfo {
	...
	public boolean equals(Object obj) {
		if (obj instanceof KeyInfo) {
			return obj != null && this.key != null
					&& this.key.equals(((KeyInfo) obj).key);
		}
		return false;
	}
	 ...
	 */
	public void addCp(String protocol, String host, String file)
			throws MalformedURLException {
	...
	public String toString() {
        ...
        strBuff.append(' ');
        strBuff.append(status == KeyInfo.STATUS_DISABLE ? "DISABLE"
                : "ENABLE");
        strBuff.append(' ');
